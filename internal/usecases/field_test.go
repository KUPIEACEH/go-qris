...
func TestNewField(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			uc := NewField(test.fields.acquirerUsecase, test.fields.switchingUsecase, test.fields.qrisTags, test.fields.qrisCategoryContents)
...
func TestFieldAssign(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				qris: &entities.QRIS{},
				data: &testQRIS.AdditionalInformation,
			},
			wantError: nil,
		},
		{
